// <auto-generated />
namespace Confiz.Commerce.RetailProxy.Extension.Adapters
{
    using System;
    ...
    public interface IStoreOperationsManager : Microsoft.Dynamics.Commerce.RetailProxy.IEntityManager
    {
        ...
        /// <returns>Collection of Microsoft.Dynamics.Commerce.Runtime.DataModel.ProductSearchResult.</returns>
        Task<Microsoft.Dynamics.Commerce.Runtime.PagedResult<Microsoft.Dynamics.Commerce.Runtime.DataModel.ProductSearchResult>> SearchProductsByTextAsync(string searchText, long channelId, Microsoft.Dynamics.Commerce.Runtime.DataModel.QueryResultSettings queryResultSettings = null);
    ...
    /// </summary>
    [GeneratedCodeAttribute("Confiz.Commerce.RetailProxy.Extension", "1.0")]
    public interface ICFZCustomerManager : Microsoft.Dynamics.Commerce.RetailProxy.IEntityManager
    {
        ...
        /// <param name="requestType">The requestType.</param>
        /// <returns>string object.</returns>
        Task<string> GetTenderTypeValueAction(Microsoft.Dynamics.Commerce.Runtime.DataModel.SalesOrder saleOrder, string requestType);
        ...
        /// <param name="requestType">The requestType.</param>
        /// <returns>string object.</returns>
        Task<string> GetCredentialsAction(Microsoft.Dynamics.Commerce.Runtime.DataModel.SalesOrder salesOrder, string requestType);
        ...
        /// <param name="queryResultSettings">The queryResultSettings.</param>
        /// <returns>Collection of Microsoft.Dynamics.Commerce.Runtime.DataModel.Receipt.</returns>
        Task<Microsoft.Dynamics.Commerce.Runtime.PagedResult<Microsoft.Dynamics.Commerce.Runtime.DataModel.Receipt>> GetCouponDiscountAction(string parmStatus, decimal parmNetAmount, decimal parmQty, string parmTransactionId, string parmReceiptId, Microsoft.Dynamics.Commerce.Runtime.DataModel.CartLine parmLine, Microsoft.Dynamics.Commerce.Runtime.DataModel.QueryResultSettings queryResultSettings = null);
        ...
        /// <param name="parmLine">The parmLine.</param>
        /// <returns>string object.</returns>
        Task<string> GetCouponValidationAction(string parmStatus, decimal parmNetAmount, decimal parmQty, string parmTransactionId, string parmReceiptId, Microsoft.Dynamics.Commerce.Runtime.DataModel.CartLine parmLine);
        ...
        /// <param name="queryResultSettings">The queryResultSettings.</param>
        /// <returns>Collection of Microsoft.Dynamics.Commerce.Runtime.DataModel.Receipt.</returns>
        Task<Microsoft.Dynamics.Commerce.Runtime.PagedResult<Microsoft.Dynamics.Commerce.Runtime.DataModel.Receipt>> GetCouponsAction(string products, string transactionId, string returnTransactionId, string receiptId, string storeId, string terminalId, string transactionDate, string couponCode, string customerId, string requestType, Microsoft.Dynamics.Commerce.Runtime.DataModel.QueryResultSettings queryResultSettings = null);
        ...
        Task<Microsoft.Dynamics.Commerce.Runtime.DataModel.Cart> VoidPaymentOnVoidTransactionAsync(string cartId);
    ...
    /// </summary>
    [GeneratedCodeAttribute("Confiz.Commerce.RetailProxy.Extension", "1.0")]
    public interface IGKCustomerEntityManager : Microsoft.Dynamics.Commerce.RetailProxy.IEntityManager
    {
        ...
        /// <param name="queryResultSettings">The queryResultSettings.</param>
        /// <returns>Collection of CommerceRuntime.Entities.GKCustomer.GKCustomerEntity.</returns>
        Task<Microsoft.Dynamics.Commerce.Runtime.PagedResult<CommerceRuntime.Entities.GKCustomer.GKCustomerEntity>> CreateUpdateCustomer(string lMSID, string mobileNumber, string searchName, string email, string legalEntity, string firstName, string lastName, string gender, string dOB, string profileCompleted, string nationality, string residenceCountry, string residenceCity, string memberTier, Microsoft.Dynamics.Commerce.Runtime.DataModel.QueryResultSettings queryResultSettings = null);
    ...
    /// </summary>
    [GeneratedCodeAttribute("Confiz.Commerce.RetailProxy.Extension", "1.0")]
    public interface IGKCouponCheckEntityManager : Microsoft.Dynamics.Commerce.RetailProxy.IEntityManager
    {
        ...
        /// <param name="queryResultSettings">The queryResultSettings.</param>
        /// <returns>Collection of CommerceRuntime.Entities.GKLoyalty.GKCouponCheckEntity.</returns>
        Task<Microsoft.Dynamics.Commerce.Runtime.PagedResult<CommerceRuntime.Entities.GKLoyalty.GKCouponCheckEntity>> ApplyGKCoupon(string couponBarCode, int memberId, string cartID, long cartVersion, Microsoft.Dynamics.Commerce.Runtime.DataModel.QueryResultSettings queryResultSettings = null);
    ...
    /// </summary>
    [GeneratedCodeAttribute("Confiz.Commerce.RetailProxy.Extension", "1.0")]
    public interface IGKOfflineTransactionEntityManager : Microsoft.Dynamics.Commerce.RetailProxy.IEntityManager
    {
        ...
        /// </summary>
        /// <param name="queryResultSettings">The queryResultSettings.</param>
        /// <returns>Collection of CommerceRuntime.Entities.GKLoyalty.GKOfflineTransactionEntity.</returns>
        Task<Microsoft.Dynamics.Commerce.Runtime.PagedResult<CommerceRuntime.Entities.GKLoyalty.GKOfflineTransactionEntity>> GetOffLineTransactions(Microsoft.Dynamics.Commerce.Runtime.DataModel.QueryResultSettings queryResultSettings = null);
    ...
    /// </summary>
    [GeneratedCodeAttribute("Confiz.Commerce.RetailProxy.Extension", "1.0")]
    public interface IGKMemberEntityManager : Microsoft.Dynamics.Commerce.RetailProxy.IEntityManager
    {
        ...
        /// <param name="staffId">The staffId.</param>
        /// <param name="queryResultSettings">The queryResultSettings.</param>
        /// <returns>Collection of CommerceRuntime.Entities.GKLoyalty.GKMemberEntity.</returns>
        Task<Microsoft.Dynamics.Commerce.Runtime.PagedResult<CommerceRuntime.Entities.GKLoyalty.GKMemberEntity>> IfGKMemberExists(string customerIdBarCode, string transId, string staffId, Microsoft.Dynamics.Commerce.Runtime.DataModel.QueryResultSettings queryResultSettings = null);
